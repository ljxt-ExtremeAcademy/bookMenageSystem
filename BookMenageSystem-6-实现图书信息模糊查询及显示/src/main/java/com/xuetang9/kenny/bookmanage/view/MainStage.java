...
public class MainStage extends Stage {
    ...
    private void changeByText(String text) {
        ...
        //根据按钮的文本显示对应的面板
        contentPane.getChildren().clear();      //清空右侧面板
        contentPane.getChildren().add(MainStagePaneFactory.CreatePaneByText(text));
        //contentPane.getChildren().add(new BookManagePane());
    }
